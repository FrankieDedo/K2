...
The project of recreating Bae Camp is kinda complete, and most of the stuff should work alright. I'll focus on new features and solidifying those that are already implemented. I think that there is still some streamlining and optimization to do, but i should manage to iron out everything soon. Anyway, here are the features implemented as of now:
<h1>How to use</h1>
...
If you need a more detailed guide, check this out: <a href='https://github.com/FrankieDedo/K2/blob/master/docs/Installation.md'>K2 - Installation</a>
