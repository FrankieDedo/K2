# _PROJECT_MAP.md — cache/index of the K2 project

> **Read this file at the start of every session.** It is the project structure
> cache: avoids re-scanning folders (Mountain Base Camp, DisplayPad SDK, K2,
> Profili) each conversation, saving tokens.
> If you add or modify relevant files, **update this index too**.
